...
install_dependencies() {
  ...
  # =========================================================================
  #   FINAL FIX: In Ubuntu 24.04 (Noble), vncpasswd was moved to its
  #   own package, 'tigervnc-tools'. It must be included here.
  # =========================================================================
...
configure_system() {
  ...
  # Now that we're installing 'tigervnc-tools', this command will work.
  echo "$VNC_PASSWORD" | /usr/bin/vncpasswd -f > "$vnc_pass_file"
